  ...
  return (
    <div className="p-5">
      ...
      <div className="mb-3">
        ...
        <p className="mt-1 text-xs font-bold font-semibold tracking-wider text-slate-600 uppercase">
          {foodItem.category}
        </p>
      </div>

      {/* Description */}
      <p className="text-m mb-5 line-clamp-2 min-h-10 leading-5 tracking-wide text-slate-600">{foodItem.description}</p>
